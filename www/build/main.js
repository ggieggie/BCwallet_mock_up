    ...
    TransactionPage.prototype.getAssets = function () {
        ...
        this.http.post("https://yqqc8r7eeh.execute-api.us-west-2.amazonaws.com/prod/ab", body, options)
            ...
            if (JSON.stringify(result.result) == "null" || JSON.stringify(result.result) == "[]") {
                ...
                _this.assets = JSON.stringify(result.result[0].name).substr(1, 8);
...
AccountPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-account',template:/*ion-inline-start:"/Users/veggie/prod3-master/src/pages/account/account.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      アカウント情報\n    </ion-title>\n    <ion-buttons end>\n      <button ion-button (click)="returntabs()" color="primary">戻る︎</button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="outer-content">\n  <div padding-top text-center *ngIf="username">\n    <img src="assets/img/{{iconId}}" alt="avatar">\n    <h2>{{username}}</h2>\n    <h2>{{email}}</h2>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/veggie/prod3-master/src/pages/account/account.html"*/
    }),
